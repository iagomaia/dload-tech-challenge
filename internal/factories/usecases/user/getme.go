...
var getMeUseCase usecases.IGetMe

func GetGetMeUseCase() usecases.IGetMe {
	if getMeUseCase == nil {
		getMeUseCase = &userservices.GetMeUseCase{
			GetUserByIDRepository: userrepositoriesfactories.GetGetUserByIDRepository(),
		}
	}
